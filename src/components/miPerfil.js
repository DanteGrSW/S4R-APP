		...
		if (cookies.get('_id') === props.match.params._id || cookies.get('idRol') === '1') {
			return (
				<div className="d-flex justify-content-center">
					<button className="btn btn-primary mx-2 my-2" onClick={() => editData('Editar', perfil)}>
						Editar datos
					</button>
					<button className="btn btn-secondary mx-2 my-2" onClick={() => editData('Contraseña', perfil)}>
						Cambiar Contraseña
					</button>
				</div>
			);
